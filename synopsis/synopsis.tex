...
\begin{enumerate}
\item MetaLabeler~\ref{Tang:2009:LSM:1526709.1526738}---mapping from the feature vector to the number of labels per instance based on:\\
...
\item Artificial label for threshold extraction. Similar as above, but instead of treating the label as a cut point the threshold is acquired by extracting the label counter.% and using it as a threshold.
